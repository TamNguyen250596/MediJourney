...
interface UserRecommendRecipeRepository {
    suspend fun observeUserRecommendRecipes()
    fun getUserRecommendRecipesFlow(): Flow<List<UserRecommendRecipe>>
}

class UserRecommendRecipeRepositoryImpl @Inject constructor() : UserRecommendRecipeRepository {
...
abstract class UserRecommendRecipeModule {
    ...
    abstract fun bindUserRecommendRecipeRepository(
        impl: UserRecommendRecipeRepositoryImpl
    ): UserRecommendRecipeRepository
}
